...
def scu_model(nb_classes, Chans = 64, Samples = 128, 
    ...
    print('Using scu_model with input shape = {}'.format(input1.shape))

    
    block1       = Conv2D(F1, (1, kernLength), padding = 'same',
                                   input_shape = (1, Chans, Samples),
                                   use_bias = False, strides = (1, 1),
                                   data_format='channels_first')(input1)   # By GTL channel_first, stride was (1,2)
    block1       = BatchNormalization(axis = 1)(block1)  
    block1       = Activation('relu')(block1)
    block1       = MaxPool2D((1, 2),data_format='channels_first')(block1)
    block1       = dropoutType(dropoutRate)(block1)  
    print('Shape after first Conv2D = {}'.format(block1.shape))
    
    
    block1       = Conv2D(32, (1, kernLength), padding = 'same',
                                   use_bias = False, strides = (1, 1),
                                   data_format='channels_first')(block1)   # stride was (1,2)
    block1       = BatchNormalization(axis = 1)(block1)  
    block1       = Activation('relu')(block1)
    block1       = MaxPool2D((1, 2),data_format='channels_first')(block1)
    block1       = dropoutType(dropoutRate)(block1)  
    print('Shape after second Conv2D = {}'.format(block1.shape))
    ...
    block1       = MaxPool2D((1, 2),data_format='channels_first')(block1)
    block1       = dropoutType(dropoutRate)(block1)  
    print('Shape after third Conv2D = {}'.format(block1.shape))
    ...
    block1       = MaxPool2D((1, 2),data_format='channels_first')(block1)
    block1       = dropoutType(dropoutRate)(block1)  
    print('Shape after fourth Conv2D = {}'.format(block1.shape))
    ...
    print('Shape after first dense = {}'.format(dense.shape))
    
    dense        = Dense(60, name = 'dense2', 
                         kernel_constraint = max_norm(norm_rate))(dense)
    dense       = Activation('relu')(dense)
    dense       = dropoutType(dropoutRate)(dense)  
    print('Shape after second dense = {}'.format(dense.shape))
